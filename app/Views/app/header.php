...
<html>
<head>
<title>Gestion de denuncias</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content=" Plataforma de gestion de denuncias" />
...
<!-- //font-awesome icons CSS-->
<!-- side nav css file -->
<link href='https://cdn.datatables.net/1.13.6/css/dataTables.bootstrap.min.css' media='all' rel='stylesheet' type='text/css'/>
...
<body class="cbp-spmenu-push">
	...
	<!--footer-->
	<div class="footer">
	   <p>&copy;2018 Grupo Ademy <a href="#" target="_blank">Plataforma Educativa</a></p>		
	</div>
    <!--//footer-->
	</div>
